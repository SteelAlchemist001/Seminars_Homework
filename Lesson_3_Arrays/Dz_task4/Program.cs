...
// Вроде бы понятно но не как не получаеться написать когда делаю упрожнения из SWIFT PLAYGRAUNT то там в стиле игры и того что  унас на уроках было когда оттвечатил на вопросы